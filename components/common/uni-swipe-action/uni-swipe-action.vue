    ...
    >
      ...
      <view class="uni-swipe-action__btn-group" :id="elId">
        <div
          ...
          :style="{backgroundColor: item.style && item.style.backgroundColor ? item.style.backgroundColor : '#C7C6CD',color: item.style && item.style.color ? item.style.color : '#FFFFFF',fontSize: item.style && item.style.fontSize ? item.style.fontSize : '14px',borderRadius: item.style && item.style.borderRadius ? item.style.borderRadius : '0'}"
